...
def api_root():
    ...
    if request.method == 'POST' and request.files['image']:
        ...
        image_path2 = 'C:\\Users\\ca25935\\Desktop\\UCD Data Analytics\\Final Project\\Final Project\\Final Project Repo\\Final_Project\\Final_Final\\uploads\\'
        ...
        if score <= .50:
            prediction = "Sans-Serif"
        else: prediction = "Serif"
        ...
        #return f"Our model is predicting the image belongs to the {prediction} font family!"
